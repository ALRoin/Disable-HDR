 ...
 * because this class, and the two android.view.Display* methods the native
 * side hooks, are never app-defined - they're either this stub or plain
 * AOSP framework classes, both resolvable without the app's real
 * ClassLoader, which may not even exist yet this early in process
 * specialization.
 *
 ...
 * the original call (a Display or Display.HdrCapabilities instance here);
 * neither hook below needs to inspect it since the replacement answer is
 * fixed either way.
 */
