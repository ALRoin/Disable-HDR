 ...
 *
 * install() is invoked from C++ (hdr_block.cpp) right after the app's own
 ...
 * actually reports.
 */
public final class HdrHook {

    private static final String TAG = "HdrBlockHook";
    ...
    private static void hookGetHdrCapabilities() throws Exception {
        ...
        Method hook = HdrHook.class.getDeclaredMethod("getHdrCapabilities_hook", Display.class);
        Method backup = HdrHook.class.getDeclaredMethod("getHdrCapabilities_backup", Display.class);
    ...
    private static void hookIsHdr() throws Exception {
        ...
        Method hook = HdrHook.class.getDeclaredMethod("isHdr_hook", Display.class);
